                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {['Investment Banking Interview Guide', 'Private Equity Case Study', 'Sales & Trading Overview'].map((item, i) => (
                                <div key={i} className="bg-nothing-dark-grey p-6 border border-esf-midnight/10 hover:border-nothing-red transition-colors group cursor-pointer">
                                    <h3 className="font-bold text-lg mb-2 group-hover:text-nothing-red transition-colors font-dot uppercase">{item}</h3>
                                    <p className="text-sm text-esf-blue mb-4 font-mono">Comprehensive PDF guide covering technicals and behavioral questions.</p>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {['DCF Valuation Template', 'LBO Model (Basic)', 'Comps Analysis Sheet'].map((item, i) => (
                                <div key={i} className="bg-nothing-dark-grey p-6 border border-esf-midnight/10 hover:border-nothing-red transition-colors group cursor-pointer">
                                    <h3 className="font-bold text-lg mb-2 group-hover:text-nothing-red transition-colors font-dot uppercase">{item}</h3>
                                    <p className="text-sm text-esf-blue mb-4 font-mono">Excel template with pre-built formulas and sensitivity analysis.</p>
                                    <div className="flex items-center gap-2 text-nothing-red text-sm font-bold uppercase tracking-widest">
                                        <Download size={16} /> Download
                                    </div>
                                </div>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-nothing-dark-grey p-6 border border-esf-midnight/10 flex gap-6 items-start hover:border-nothing-white transition-colors">
                                    <div className="w-24 h-32 bg-gray-800 flex-shrink-0 border border-esf-midnight/10"></div>
                                    <div>
                                        ...
                                        <p className="text-sm text-esf-blue font-mono">{book.desc}</p>
                                        <a href="#" className="inline-flex items-center gap-1 text-esf-midnight text-xs mt-4 hover:text-nothing-red uppercase tracking-widest">
